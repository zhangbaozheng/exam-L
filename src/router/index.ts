 ...
 * @LastEditTime: 2020-10-20 13:02:36
 * @LastEditors: 赵舒婷
...
import Classlist from '@/views/paper/paper-item/ClassList';
import ClassMate from '@/views/paper/paper-item/ClassMate';
import ClassDetail from '@/views/paper/paper-item/ClassDetail'
const routes = [
    {
        path: "/",
        redirect: "/index",
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "阅卷管理",
                component:Paper,
                redirect: '/index/paper/classlist',
                children: [
                    {
                        path: "/index/paper/classlist",
                        name: "待批班级",
                        component: Classlist,
                    },
                    {
                        path: "/index/paper/classmate",
                        name: "待批试卷",
                        component: ClassMate,
                    },
                    {
                        path: "/index/paper/detail/:id",
                        name: "试卷详情",
